...
namespace Vion.ServiceProvider.Sdk.RegistrationFlow
{
    ...
    public delegate Task ServiceProviderMessageHandler(IServiceProviderPublish publisher, MqttApplicationMessage message, Guid correlationId, CancellationToken cancellationToken);
}